...
import rawObjectsColors from "../globalStyles/styles.json"; // JSON com strings como "marronStyle", "amareloStyle", etc
import style from "../globalStyles/Table.module.css"; // CSS Module
